...
const htmlTemplate = (qrImageUri, mobileUrl) => `<div><h1> Airport Verification</h1><img src="${qrImageUri}" /></div><div><a href="${mobileUrl}">Click here if on mobile</a></div>`
const htmlTemplate2 = () => `<div><h1> COVID-19 Certificate: Valid </h1></div>`
let endpoint = ''
